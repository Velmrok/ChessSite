  ...
  {loading ? (
    ...
    <table className="min-w-[600px] w-full text-white font-MyFancyFont bg-gray-800/30 rounded-lg">
      <thead className="bg-gray-900/50">
        <tr>
          <th className="py-2 px-4">{t.gameHistory.players}</th>
          <th className="py-2 px-4">{t.gameHistory.result}</th>
          <th className="py-2 px-4">{t.gameHistory.analysis}</th>
          <th className="py-2 px-4">{t.gameHistory.date}</th>
        </tr>
              </thead>
              <tbody>
                {games.length === 0 ? (
