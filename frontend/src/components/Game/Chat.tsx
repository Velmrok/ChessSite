...
export default function Chat({previousMessages}: Props){
    ...
    return (
        <div className="w-full h-[50%] bg-black/40 rounded-lg font-MyFancyFont p-2 overflow-y-auto flex flex-col justify-between">
            <h2 className="text-white font-MyFancyFont text-lg mb-2">{t.game.chat.title}</h2>
            <div
            ...
            type="text" className="w-full h-full p-2 focus:outline-2 focus:outline-white rounded-sm" placeholder={t.game.chat.placeholder}></input>
            </div>
